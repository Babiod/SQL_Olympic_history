SELECT * FROM Olympic_history.athlete_events;
...
1. How many olympics games have been held?
    ...
    from olympic_history.athlete_events;
...
2. List down all Olympics games held so far. (Data issue at 1956-"Summer"-"Stockholm")
    ...
    from Olympic_history.athlete_events oh
    order by year;
...
3. Mention the total no of nations who participated in each olympics game?
    ...
    with all_countries as
        ...
        from Olympic_history.athlete_events oh
        join olympic_history.noc_regions nr 
        ON nr.noc = oh.noc
...
4. Which year saw the highest and lowest no of countries participating in olympics
      ...
      with all_countries as
              (select games, nr.region
              from Olympic_history.athlete_events oh
              join olympic_history.noc_regions nr ON nr.noc=oh.noc
              group by games, nr.region),
          tot_countries as
              (select games, count(1) as total_countries
              from all_countries
...
5. Which nation has participated in all of the olympic games
      ...
      with t1 as
          	(select count(distinct games) as total_games
          	from Olympic_history.athlete_events where season = 'Summer'),
          t2 as
...
13. Top 5 most successful countries in olympics. Success is defined by no of medals won.
    ...
    with t1 as
            ...
            from Olympic_history.athlete_events oh
            join Olympic_history.athlete_events_noc_regions nr on nr.noc = oh.noc
            where medal <> 'NA'
            group by nr.region
            order by total_medals desc),
        t2 as
